...
export class FirebaseService {
  ...
  // }
  //
  // // uploadCategoryImage(file: File, venueId: string): Observable<any> {
  // //   const formData = new FormData();
  // //   formData.append('image', file);
  // //   formData.append('pathname', 'category-images'); // 🆕 send to control path
  // //
  ...
  //           switchMap(() => {
  //             if(newBooking.id) {
  //               return this.emailService.sendEmailAfterAppointmentCreated(newBooking, venueName)
  //             } else {
  //               return of(null);
  //             }
  //           }),
